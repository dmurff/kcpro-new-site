...
export async function createMessage(customerPhone) {
  ...
  const message = await client.messages.create({
    body: `Your order was successfull and you have been placed in our job queue! We will reach out shortly to schedule. You can call/text questions to 816-301-4776 or email us at support@kcproassembly.com.`,
    from: "+19137044870",
    to: customerPhone,
  });
