...
Here are the active jobs:${JSON.stringify(trimmedJobs, null, 2)} Here are the customers: ${JSON.stringify(trimmedCustomers, null, 2)} Use the current date to attach a time to the message ${today}`,
        },
      ],
    }),
  });
