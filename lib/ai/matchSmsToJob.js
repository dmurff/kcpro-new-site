...
rule to rule them all and final decision maker: if the fromNumber matches a customer and that customer has a job in the jobs table then use this to attach a job_id uuid to the note period.
