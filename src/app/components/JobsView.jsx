            ...
            .map((j) => {
              ...
              return (
                <Link
                  ...
                  key={j.id}
                  id={j.id}
                  className="grid lg:grid-cols-4 gap-4 lg:gap-2 text-white bg-black/80 mb-4 p-2 hover:cursor-pointer hover:focus-ring-blue-500/30 hover:bg-blue-300 rounded-md shadow-md"
                >
                  <div>
