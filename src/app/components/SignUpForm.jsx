...
const SignUpForm = () => {
  // global styling
  const inputClass =
    "block w-full px-4 py-2 pr-10 mb-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500";
  //
      ...
      >
        ...
        <div className="relative">
          <input
            ...
            onChange={changeForm}
          ></input>
          <BsEye className="absolute top-1/2 right-3 transform -translate-y-1/2 text-blue-500 text-xl cursor-pointer" />
        </div>
