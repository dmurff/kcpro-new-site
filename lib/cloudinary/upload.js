...
export async function imageUpload(featureImage) {
  console.log("✅✅✅✅❤️❤️❤️:", featureImage);
  if (!featureImage) {
    return NextResponse(
  ...
  console.log("📦 Incoming data:", featureImage);

  featureImage = new FormData();
  ...
  for (const file of images) {
    ...
    return imageUrls.push(result.secure_url);
  }
}
