...
const cards = [
  {
    ...
    description:
      "Book a job with a deposit and you instantly get a receipt and notification that your job has been added to our queue.",
    icon: PhoneIcon,
  },
  {
    name: "consultation",
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-600 sm:text-xl/8">
              We offer a range of hoop services in the Kansas City area. But
              they all have one thing in common. Upfront pricing, transparent
              services, and no hidden fees — ever.
            </p>
          </div>
