      ...
      messages: [
        {
          ...
          Each message is a separate conversation not a cut off of the one before. 
          So are some rules: 
          - If there is no context at all about what phase of the job they are discussing assume they are picking up where the last conversation left off and the topic is unchanged.
          - If the appointment being scheduled is named then make sure to clearly show which part of the job they are discussing.
          
          Return JSON only, no markdown, no backticks, in this format:
{
  "customer_name": "",
  "job_type": "",
  "address": "",
  "current_status": "one paragraph summary of where this job stands right now",
  "next_appointment": "date and time or null",
  "action_needed": "what the business owner needs to do next, or null",
  "recent_changes": "what changed in the most recent conversation, or null",
  "timeline": [
    {"date": "", "event": "brief description of what happened"}
  ]
}`,
          //           content:
